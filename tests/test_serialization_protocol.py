...
class TestConnectionProtocol:
    ...
    def test_connection_to_dict_is_json_serializable(self) -> None:
        ...
        conn = Connection(
            "github",
            secrets=SecretKeys(token="GITHUB_TOKEN", org=Binding("GITHUB_ORG", optional=True)),
...
class TestWireFormatRoundTrip:
    ...
    def test_connection_round_trip(self) -> None:
        ...
        conn = Connection(
            "openai",
            secrets=SecretKeys(api_key="OPENAI_API_KEY", org_id=Binding("OPENAI_ORG", default="default_org")),
    ...
    def test_secret_values_list_serialize(self) -> None:
        ...
        creds = [SecretValues(github, token="ghp_xxx"), SecretValues(openai, api_key="sk_xxx")]
...
class TestDuckTypingCompatibility:
    ...
    def test_custom_secret_values_like_object(self) -> None:
        ...
        class CustomSecretValues:
            ...
            def to_dict(self) -> dict[str, Any]:
                return {"connection_name": self._connection.name, "values": self._values}
...
class TestSDKIntegrationFormat:
    ...
    def test_connection_provisioning_payload(self) -> None:
        ...
        conn = Connection(
            "github", secrets=SecretKeys(token="GITHUB_TOKEN"), base_url="https://api.github.com", timeout_ms=30000
        )
    ...
    def test_multiple_connections_provisioning(self) -> None:
        ...
        github = Connection("github", secrets=SecretKeys(token="TOKEN"), base_url="https://api.github.com")
        openai = Connection("openai", secrets=SecretKeys(api_key="KEY"), base_url="https://api.openai.com/v1")
