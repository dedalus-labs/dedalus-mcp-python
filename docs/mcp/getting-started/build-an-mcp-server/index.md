...
If your server isn't being picked up by Claude for Desktop, proceed to the [Troubleshooting](troubleshooting.md#troubleshooting) section for debugging tips.
