...
This overview of the Model Context Protocol (MCP) discusses its [scope](scope.md#scope) and [core concepts](concepts-of-mcp.md#concepts-of-mcp), and provides an [example](example.md#example) demonstrating each core concept.
