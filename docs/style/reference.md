...
> **Tooling Note:** This reference mentions `pylint`, `Black`, and `Pyink`. At Dedalus, we use modern equivalents:
...
<h4 id="3164-guidelines-derived-from-guidos-recommendations">3.16.4 Guidelines derived from [Guido](https://en.wikipedia.org/wiki/Guido_van_Rossum)’s Recommendations</h4>
